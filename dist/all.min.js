  ...
  jQuery(function($){
    ...
    $x = 0;
      ...
      if (value <= 0) {
        ...
        var new_currency = one * two; //total amount
        //alert(new_currency);
        var new_currency2 = Math.abs(new_currency - value);
        //alert(new_currency2);
        var new_currency2 = new_currency2 * VAT;
        //alert(new_currency2);
        var new_currency2 = new_currency2.toFixed(2);
        //alert(new_currency2);
        var three = parseFloat(one);
        //alert(three);
        var four = parseFloat(new_currency2);
        //alert(four);
        var new_currency = three + four;
        //alert(new_currency);
        var new_currency = new_currency.toFixed(2);
        //alert(new_currency);
       // var new_currency = new_currency * VAT;
        var wolrdpayamount = new_currency;// new_currency.replace(",", new_currency);
