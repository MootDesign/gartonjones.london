...
<div id="pano" style="width:100%;height:100%;">
	...
	<script>
        embedpano({swf:"<?php echo get_template_directory_uri(); ?>/360/nine-elms-final/tour.swf", xml:"<?php echo get_template_directory_uri(); ?>/360/nine-elms-final/tour.xml", target:"pano", html5:"auto", passQueryParameters:true});
	</script>
</div>
      ...
      <div id="<?php echo $id; ?>" class="parallax team-info reveal-modal" data-reveal>
        <div class="team-bg">
          <a href="#" class="close-reveal-modal">
            ...
            <hr class="sidesep">
            <ul class="links">
              <li><a href="<?php echo home_url( '/offices/nine-elms/' ); ?>">Learn more about our Nine Elms & Vauxhall Office</a></li>
              <li><a href="<?php echo home_url( '/contact-us/#nine-elms' ); ?>">Contact the Office</a></li>
            </ul>
        </div>
      </div>
...
<div class="the-wrapper content">
	...
	<div class="the-strips">
		<ul>
			...
			<li data-image="nine-elms"><a href="/offices/victoria-and-pimlico/team/"><h3>Victoria & Pimlico</h3></a></li>
