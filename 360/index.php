  ...
  <div id="team-fly">
    <div class="view-offices-wrapper" style="vertical-align: text-bottom;">
     ...
     victoria Office
      ...
      <a class="view-other" href="/offices/victoria/">Learn more about this office</a><br>
      <a class="view-other" href="/contact-us/#victoria">Contact us</a>
    </div>
  </div>
    ...
    ?>
      ...
      <div id="<?php echo $id; ?>" class="parallax team-info reveal-modal" data-reveal>
        ...
        <?php } ?>
            ...
            <hr class="sidesep">
            <ul class="links">
              <li><a href="<?php echo home_url( '/offices/victoria/' ); ?>">Learn more about our Westminster Office</a></li>
              <li><a href="<?php echo home_url( '/contact-us/#victoria' ); ?>">Contact the Office</a></li>
            </ul>
        </div>
      </div>
      <?php }
