...
$getOnlyOffice = 'victoria and pimlico';
...
<div id="<?php echo $id; ?>" class="parallax team-info">
  ...
  <div class="button-close">
      ...
      <hr class="sidesep">
      <ul class="links">
        <li><a href="<?php echo home_url('/offices/victoria-and-pimlico/'); ?>">+ Learn More About Our Victoria & Pimlico Office</a></li>
        <li><a href="<?php echo home_url('/contact-us/#victoria-and-pimlico'); ?>">+ Contact The Office</a></li>
      </ul>
  </div>
</div>
    <?php endwhile; ?>
<?php endif;
  ...
  <div id="team-fly">
    <div class="view-offices-wrapper" style="vertical-align: text-bottom;">
      ...
      Victoria and Pimlico Office
    </div><div class="" style="margin-top: 5px;">
      <a class="view-other" href="/offices/victoria-and-pimlico/">Learn more about this office</a><br>
      <a class="view-other" href="/contact-us/#victoria-pimlico">Contact us</a>
    </div>
  </div>
  ...
  <div id="team-wrapper" class="small 12 medium 12 large-12 columns">
    ...
    <?php if ( have_rows( 'member' ) )
      ...
      $description = get_sub_field( 'description' );
    ?>
      <div id="team-tale" class="small-6 medium-6 large-3 columns">
          <img class="load-me" data-src="<?php echo $image; ?>" alt="" class="profile" />
          <h2><?php echo $name; ?></h2>
      ...
      <div id="<?php echo $id; ?>" class="parallax team-info reveal-modal" data-reveal>
        <div class="team-bg">
          <a href="#" class="close-reveal-modal">
            ...
            <hr class="sidesep">
            <ul class="links">
              <li><a href="<?php echo home_url( '/offices/victoria-and-pimlico' ); ?>">Learn more about our Victoria and Pimlico Office</a></li>
              <li><a href="<?php echo home_url( '/contact-us/#victoria-and-pimlico' ); ?>">Contact the Office</a></li>
            </ul>
        </div>
      </div>
...
<div class="the-wrapper content">
  ...
  <div class="the-strips">
    <ul>
      <li data-image="westminster"><a href="/offices/westminster/team/"><h3>Westminster & St James's</h3></a></li>
