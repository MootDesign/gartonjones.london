...
$getOnlyOffice = 'westminster';

$detect = new Mobile_Detect();
$mapview = false;

if ( $detect->isMobile() && $mapview == true ) {
?>
...
<div id="<?php echo $id; ?>" class="parallax team-info">
  <div class="team-bg">
    ...
    <div class="button-close">
      ...
      <hr class="sidesep">
      <ul class="links">
        <li><a href="<?php echo home_url('/offices/westminster/'); ?>">+ Learn More About Our <?php the_title(); ?> Office</a></li>
        <li><a href="<?php echo home_url('/contact-us/#westminster'); ?>">+ Contact The Office</a></li>
      </ul>
  </div>
</div>
    <?php }
  ...
  <div id="team-fly">
    <div class="view-offices-wrapper" style="vertical-align: text-bottom;">
      ...
      Westminster & St James's Office
    </div><div class="" style="margin-top: 5px;">
      <a class="view-other" href="/offices/westminster/">Learn more about this office</a><br>
      <a class="view-other" href="/contact-us/#westminster">Contact us</a>
    </div>
  </div>
  ...
  <div id="team-wrapper" class="small 12 medium 12 large-12 columns">
    ...
    <?php if ( have_rows( 'member' ) )
      ...
      $description = get_sub_field( 'description' );
    ?>
      <div id="team-tale" class="small-6 medium-6 large-3 columns" style="margin-bottom: 15px; margin-top: 15px;">
          ...
          <div class="team-tale-details"><p>
              ...
              <div class="contact">
              <?php if ( $phone ) { ?>
              <a href="tel:<?php echo $phone; ?>" class="tel">Office <?php echo $phone; ?></a>
              <?php } ?>

              <?php if ( $mobile ) { ?>
                <a href="tel:<?php echo $mobile; ?>" class="tel">Mobile <?php echo $mobile; ?></a>
              <?php } ?>

              <?php if ( $fax ) { ?>
                <a href="tel:<?php echo $fax; ?>" class="tel">Fax <?php echo $fax; ?></a>
              <?php } ?>
      ...
      <div id="<?php echo $id; ?>" class="parallax team-info reveal-modal" data-reveal>
        <div class="team-bg">
          <a href="#" class="close-reveal-modal">
            ...
            <hr class="sidesep">
            <ul class="links">
              <li><a href="<?php echo home_url( '/offices/westminster/' ); ?>">Learn more about our Westminster & St James’s Office</a></li>
              <li><a href="<?php echo home_url( '/contact-us/#westminster' ); ?>">Contact the Office</a></li>
            </ul>
        </div>
      </div>
...
<div class="the-wrapper content">
  ...
  <div class="the-strips">
    <ul>
      <li data-image="westminster"><a href="/offices/victoria-and-pimlico/team/"><h3>Victoria & Pimlico</h3></a></li>
      <!-- <li data-image="chelsea"><a href="/team/chelsea-bridge-wharf/"><h3>Chelsea Bridge Wharf</h3></a></li> -->
      <li data-image="nine-elms"><a href="/offices/nine-elms/team/"><h3>Nine Elms & Vauxhall</h3></a></li>
