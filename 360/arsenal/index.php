...
<div id="pano" style="width:100%;height:100%;">
	...
	<script>
		embedpano({swf:"<?php echo get_template_directory_uri(); ?>/360/arsenal/tour.swf", xml:"<?php echo get_template_directory_uri(); ?>/360/arsenal/tour.xml", target:"pano", html5:"prefer", passQueryParameters:true});
	</script>
</div>
...
<div id="<?php echo $id; ?>" class="parallax team-info">
	...
	<div class="team-bg">
			...
			<hr class="sidesep">
			<ul class="links">
				<li><a href="<?php ?>">+ Learn more about our Arsenal Office</a></li>
...
<!-- 		<img class="royal-arsenal load-me" data-src="<?php echo get_template_directory_uri() ?>/img/properties/one-tower-bridge.jpg" />
...
<!-- 			<li data-image="royal-arsenal"><a href="/team/royal-arsenal/"><h3>Royal Arsenal</h3></a></li>
