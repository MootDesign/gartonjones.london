...
<div id="parallax-wrapper">
  <div id="news-row" class="row fullWidth switch-me">
    <div class="page-title columns small-12 medium-12 active">
      <h2>News</h2>
      <h3>Category - <?php echo single_cat_title(); ?></h3>
    </div>
    ...
    <div class="columns medium-8 active content-here" data-order="1">
      <div id="strips" class="the-strips">
        <ul>
          <?php
            global $wp_query;
            gj_get_posts( $wp_query->query_vars );
          ?>
        </ul>
      </div>
    </div>
    ...
    <div class="columns medium-3 large-2 featured sidebar-here" data-order="2">
      ...
      <div class="stay-in-touch">
        ...
        <ul>
          ...
          <li><a href="mailto:"><img src="<?php echo get_template_directory_uri() ?>/img/news/email.png" alt="Email"></a></li>
        </ul>
      </div>
