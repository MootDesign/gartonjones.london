...
}(window));/* FWDS3DCovCategoriesMenu */
(function(window)
{
...
(function(window)
{
	var FWDS3DCovData = function(props)
	{
		...
		this.parseProperties = function()
		{
			...
			{
				errorMessage = "Coverflow data list id is not defined in FWD3DCoverflow constructor function!";
			...
			{
				self.dispatchEvent(FWDS3DCovData.LOAD_ERROR, {text:"Coverflow graphics skin path is not defined in FWD3DCoverflow constructor function!"});
				return;
			}

			var myUrl = "/coverflow/load/skin_black/"; // instead of: self.propsObj.skinPath
			//set coverflow graphics
			self.preloaderPath = myUrl + "/preloader.png";

			var nextButtonNPath = myUrl + "/nextButtonNormalState.png";
			var nextButtonSPath = myUrl + "/nextButtonSelectedState.png";
			var prevButtonNPath = myUrl + "/prevButtonNormalState.png";
			var prevButtonSPath = myUrl + "/prevButtonSelectedState.png";
			var playButtonNPath = myUrl + "/playButtonNormalState.png";
			var playButtonSPath = myUrl + "/playButtonSelectedState.png";
			var pauseButtonPath = myUrl + "/pauseButtonSelectedState.png";
			var handlerLeftNPath = myUrl + "/handlerLeftNormal.png";
			var handlerLeftSPath = myUrl + "/handlerLeftSelected.png";
			self.handlerCenterNPath = myUrl + "/handlerCenterNormal.png";
			self.handlerCenterSPath = myUrl + "/handlerCenterSelected.png";
			var handlerRightNPath = myUrl + "/handlerRightNormal.png";
			var handlerRightSPath = myUrl + "/handlerRightSelected.png";
			var trackLeftPath = myUrl + "/trackLeft.png";
			self.trackCenterPath = myUrl + "/trackCenter.png";
			var trackRightPath = myUrl + "/trackRight.png";
			var slideshowTimerPath = myUrl + "/slideshowTimer.png";
			var slideShowPreloaderPath_str = myUrl + "/slideShowPreloader.png";
			var lightboxCloseButtonN_str = myUrl + "/closeButtonNormalState.png";
			var lightboxCloseButtonS_str = myUrl + "/closeButtonSelectedState.png";
			var lightboxNextButtonN_str = myUrl + "/lightboxNextButtonNormalState.png";
			var lightboxNextButtonS_str = myUrl + "/lightboxNextButtonSelectedState.png";
			var lightboxPrevButtonN_str = myUrl + "/lightboxPrevButtonNormalState.png";
			var lightboxPrevButtonS_str = myUrl + "/lightboxPrevButtonSelectedState.png";
			var lightboxPlayButtonN_str = myUrl + "/lightboxPlayButtonNormalState.png";
			var lightboxPlayButtonS_str = myUrl + "/lightboxPlayButtonSelectedState.png";
			var lightboxPauseButtonN_str = myUrl + "/lightboxPauseButtonNormalState.png";
			var lightboxPauseButtonS_str = myUrl + "/lightboxPauseButtonSelectedState.png";
			var lightboxMaximizeButtonN_str = myUrl + "/maximizeButtonNormalState.png";
			var lightboxMaximizeButtonS_str = myUrl + "/maximizeButtonSelectedState.png";
			var lightboxMinimizeButtonN_str = myUrl + "/minimizeButtonNormalState.png";
			var lightboxMinimizeButtonS_str = myUrl + "/minimizeButtonSelectedState.png";
			var lightboxInfoButtonOpenN_str = myUrl + "/infoButtonOpenNormalState.png";
			var lightboxInfoButtonOpenS_str = myUrl + "/infoButtonOpenSelectedState.png";
			var lightboxInfoButtonCloseN_str = myUrl + "/infoButtonCloseNormalPath.png";
			var lightboxInfoButtonCloseS_str = myUrl + "/infoButtonCloseSelectedPath.png";
...
(function (window){
	...
	var FWDS3DCovDisplayObject = function(type, position, overflow, display){
		...
		this.setButtonMode = function(val){
                    /*
                     * I need to override the cursor, but this script doesn't add any classes to the created elements...
                     * so I had to modify the source code to use custom cursor on <img> element
                     */
			this.buttonMode = val;
			if(this.buttonMode ==  true){
// 				this.screen.style.cursor = "pointer";
				this.screen.classList.add( "plus-pointer" );
			}else{
...
(function (window){
	 ...
	 * @ display values: block, inline-block, this applies only if the position is relative.
	 */
	var FWDS3DCovDisplayObject3D = function(type, position, overflow, display){
	...
	window.FWDS3DCovDisplayObject3D = FWDS3DCovDisplayObject3D;
}(window));(function (){
 ...
 *
 * Includes all of the following: TweenLite, FWDS3DCovModTweenMax, TimelineLite, TimelineMax, EasePack, CSSPlugin, RoundPropsPlugin, BezierPlugin, AttrPlugin, DirectionalRotationPlugin
 *
...
(window._gsQueue || (window._gsQueue = [])).push( function() {
	...
	window._gsDefine("FWDS3DCovModTweenMax", ["core.Animation","core.SimpleTimeline","TweenLite"], function(Animation, SimpleTimeline, TweenLite) {

		var _slice = [].slice,
			FWDS3DCovModTweenMax = function(target, duration, vars) {
			...
			p = FWDS3DCovModTweenMax.prototype = TweenLite.to({}, 0.1, {}),
			_blankArray = [];

		FWDS3DCovModTweenMax.version = "1.9.7";
		p.constructor = FWDS3DCovModTweenMax;
		p.kill()._gc = false;
		FWDS3DCovModTweenMax.killTweensOf = FWDS3DCovModTweenMax.killDelayedCallsTo = TweenLite.killTweensOf;
		FWDS3DCovModTweenMax.getTweensOf = TweenLite.getTweensOf;
		FWDS3DCovModTweenMax.ticker = TweenLite.ticker;
...
//---- STATIC FUNCTIONS -----------------------------------------------------------------------------------------------------------
		...
		FWDS3DCovModTweenMax.to = function(target, duration, vars) {
			return new FWDS3DCovModTweenMax(target, duration, vars);
		};

		FWDS3DCovModTweenMax.from = function(target, duration, vars) {
			vars.runBackwards = true;
			vars.immediateRender = (vars.immediateRender != false);
			return new FWDS3DCovModTweenMax(target, duration, vars);
		};

		FWDS3DCovModTweenMax.fromTo = function(target, duration, fromVars, toVars) {
			toVars.startAt = fromVars;
			toVars.immediateRender = (toVars.immediateRender != false && fromVars.immediateRender != false);
			return new FWDS3DCovModTweenMax(target, duration, toVars);
		};

		FWDS3DCovModTweenMax.staggerTo = FWDS3DCovModTweenMax.allTo = function(targets, duration, vars, stagger, onCompleteAll, onCompleteAllParams, onCompleteAllScope) {
			stagger = stagger || 0;
			...
			for (i = 0; i < l; i++) {
				...
				a[i] = new FWDS3DCovModTweenMax(targets[i], duration, copy);
				delay += stagger;
			}
			return a;
		};

		FWDS3DCovModTweenMax.staggerFrom = FWDS3DCovModTweenMax.allFrom = function(targets, duration, vars, stagger, onCompleteAll, onCompleteAllParams, onCompleteAllScope) {
			vars.runBackwards = true;
			vars.immediateRender = (vars.immediateRender != false);
			return FWDS3DCovModTweenMax.staggerTo(targets, duration, vars, stagger, onCompleteAll, onCompleteAllParams, onCompleteAllScope);
		};

		FWDS3DCovModTweenMax.staggerFromTo = FWDS3DCovModTweenMax.allFromTo = function(targets, duration, fromVars, toVars, stagger, onCompleteAll, onCompleteAllParams, onCompleteAllScope) {
			toVars.startAt = fromVars;
			toVars.immediateRender = (toVars.immediateRender != false && fromVars.immediateRender != false);
			return FWDS3DCovModTweenMax.staggerTo(targets, duration, toVars, stagger, onCompleteAll, onCompleteAllParams, onCompleteAllScope);
		};

		FWDS3DCovModTweenMax.delayedCall = function(delay, callback, params, scope, useFrames) {
			return new FWDS3DCovModTweenMax(callback, 0, {delay:delay, onComplete:callback, onCompleteParams:params, onCompleteScope:scope, onReverseComplete:callback, onReverseCompleteParams:params, onReverseCompleteScope:scope, immediateRender:false, useFrames:useFrames, overwrite:0});
		};

		FWDS3DCovModTweenMax.set = function(target, vars) {
			return new FWDS3DCovModTweenMax(target, 0, vars);
		};

		FWDS3DCovModTweenMax.isTweening = function(target) {
		...
		var _getChildrenOf = function(timeline, includeTimelines) {
			...
			getAllTweens = FWDS3DCovModTweenMax.getAllTweens = function(includeTimelines) {
				return _getChildrenOf(Animation._rootTimeline, includeTimelines).concat( _getChildrenOf(Animation._rootFramesTimeline, includeTimelines) );
			};

		FWDS3DCovModTweenMax.killAll = function(complete, tweens, delayedCalls, timelines) {
			if (tweens == null) {
				tweens = true;
			}
		...
		FWDS3DCovModTweenMax.killChildTweensOf = function(parent, complete) {
			if (parent == null) {
				return;
			}
			...
			if (parent instanceof Array) {
				i = parent.length;
				while (--i > -1) {
					FWDS3DCovModTweenMax.killChildTweensOf(parent[i], complete);
				}
				return;
			}
			a = [];
		...
		FWDS3DCovModTweenMax.pauseAll = function(tweens, delayedCalls, timelines) {
			_changePause(true, tweens, delayedCalls, timelines);
		};

		FWDS3DCovModTweenMax.resumeAll = function(tweens, delayedCalls, timelines) {
...
//---- GETTERS / SETTERS ----------------------------------------------------------------------------------------------------------
		...
		p.duration = function(value) {
			if (!arguments.length) {
				return this._duration; //don't set _dirty = false because there could be repeats that haven't been factored into the _totalDuration yet. Otherwise, if you create a repeated FWDS3DCovModTweenMax and then immediately check its duration(), it would cache the value and the totalDuration would not be correct, thus repeats wouldn't take effect.
			}
...
(function(window) {
		...
		var _globals = window.GreenSockGlobals || window,
			 ...
			 * </script>
			 * <script src="js/greensock/v1.7/FWDS3DCovModTweenMax.js"></script>
			 * <script>
			 *     window.GreenSockGlobals = null; //reset it back to null so that the next load of FWDS3DCovModTweenMax affects the window and we can reference things directly like TweenLite.to(...)
			 * </script>
			 * <script src="js/greensock/v1.6/FWDS3DCovModTweenMax.js"></script>
			 * <script>
...
//----Animation getters/setters --------------------------------------------------------
		...
		p.duration = function(value) {
			...
			this._uncache(true); //true in case it's a FWDS3DCovModTweenMax or TimelineMax that has a repeat - we'll need to refresh the totalDuration.
...
}(window));/* FWDS3DCovSlideshowButton */
(function(window)
{
...
(function(window)
{
	var FWDSimple3DCoverflow = function(props)
	{
		...
		this.init = function()
		{
			...
			self.body = document.getElementById( self.propsObj.coverflowHolderDivId );
...
// 					document.body.appendChild(self.mainDO.screen);
					...
					self.mainDO.screen.id = self.propsObj.coverflowHolderDivId + "-fluidwidth";
                                        self.mainDO.screen.classList.add( 'coverflow-container' );
				}
			}
			else
			{
		...
		this.onThumbsManagerThumbClick = function(e)
		{
			if (!self.data.enableHtmlContent)
			{
					...
					//  custom action here for clicking the slideshow.
// 					console.log("ID: " + myid);

// 					console.log( e );
                    if( typeof _onCoverflowClick != "undefined" ) {
                        _onCoverflowClick( e.id);
                    }
			}
		};
...
// 					document.body.removeChild(self.mainDO.screen);
	...
	FWDSimple3DCoverflow.RESIZE = "resize";
	FWDSimple3DCoverflow.LIGHTBOX = "lightbox";
