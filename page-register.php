...
<?php endif; ?>
  <form method="post">
    ...
    <input type="submit" value="Register new account" class="submitbtn">
  </form>
</div>
 </div>
 </div>
  <div class="small-0 medium-0 large-3 columns wiref hide-for-medium-down" style="padding-top:6.5em;">
